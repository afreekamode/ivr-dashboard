...
<html>
  ...
  <link href="https://code.jquery.com/jquery-2.1.1.min.js" type="text/javascript">
    <!-- Bootstrap core CSS-->
        ...
        <li class="nav-item dropdown">
         ...
         <div class="dropdown-menu" aria-labelledby="pagesDropdown">
           ...
           <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal" style="color: blue;">Logout</a>
            ...
            <a class="dropdown-item" href="login.php?logadmin">Forgot Password</a>
            <div class="dropdown-divider"></div>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span><strong><p>&copy; <?php echo date('Y'); ?> FMN PLC All rights reserved | Developed by BA. IT Audit Department.</p></strong></span>
            </div>
          </div>
        </footer>
